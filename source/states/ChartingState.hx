...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function loadSong(daSong:String):Void
	{
		...
		FlxG.sound.playMusic('assets/songs/' + daSong + "_Inst" + TitleState.soundExt, 0.6);

		// WONT WORK FOR TUTORIAL OR TEST SONG!!! REDO LATER
		vocals = new FlxSound().loadEmbedded("assets/songs/" + daSong + "_Voices" + TitleState.soundExt);
			...
			if (FlxG.mouse.overlaps(curRenderedNotes))
			{
				curRenderedNotes.forEach(function(note:Note)
				{
					if (FlxG.mouse.overlaps(note))
					{
						...
						else if (FlxG.mouse.justPressedRight || FlxG.mouse.pressedRight)
						{
