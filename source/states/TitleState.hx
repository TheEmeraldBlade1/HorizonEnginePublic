...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if (FlxG.save.data.gt == null)
			FlxG.save.data.gt = true;

		if (FlxG.save.data.scheme == null)
			FlxG.save.data.scheme = 0;

		if (FlxG.save.data.DownScroll == null)
			FlxG.save.data.DownScroll = false;

		if (FlxG.save.data.accuracyCounter == null)
			FlxG.save.data.accuracyCounter = true;

		if (FlxG.save.data.NoteFlipX == null)
			FlxG.save.data.NoteFlipX = false;

		if (FlxG.save.data.NoteFlipY == null)
			FlxG.save.data.NoteFlipY = false;

		if (FlxG.save.data.getMiddleScroll == null)
			FlxG.save.data.getMiddleScroll = false;
